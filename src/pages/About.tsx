    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <p className="text-korean-gold text-sm tracking-widest">우리의 이야기</p>
          <h1 className="text-5xl font-bold text-primary-foreground mt-2">Our Story</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container max-w-2xl text-center">
          ...
          <p className="text-muted-foreground leading-relaxed mt-6">
            Our story begins in a small kitchen in Seoul, where our founder's grandmother would spend hours perfecting her kimchi recipe. That same dedication to quality and authenticity now lives in every dish we serve. From our stone-pot bibimbap to our tender bulgogi, each recipe has been refined over three generations.
          </p>
          <p className="text-muted-foreground leading-relaxed mt-6">
      ...
      {/* Values */}
      <section className="py-16 bg-korean-warm">
        <div className="container text-center">
          <p className="text-korean-sub">우리의 가치</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
            {values.map((v) => (
              <div key={v.title} className="p-6 rounded-lg bg-card border border-border text-center">
                ...
                <p className="text-korean-gold text-sm">{v.korean}</p>

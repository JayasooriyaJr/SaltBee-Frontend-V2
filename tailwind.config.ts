    ...
    extend: {
      ...
      keyframes: {
        ...
        "bee-fly": {
          ...
          "12.5%": { transform: "translate(25px, -15px) rotate(20deg)" },
          "25%": { transform: "translate(45px, -5px) rotate(15deg)" },
          "37.5%": { transform: "translate(30px, 15px) rotate(-15deg)" },
          "50%": { transform: "translate(0, 20px) rotate(-10deg)" },
          "62.5%": { transform: "translate(-25px, 10px) rotate(-25deg)" },
          "75%": { transform: "translate(-45px, -10px) rotate(-20deg)" },
          "87.5%": { transform: "translate(-30px, -20px) rotate(25deg)" },
